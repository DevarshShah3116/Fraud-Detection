      ...
      <main className="container py-16 space-y-8">
        ...
        <section className="rounded-lg border p-6">
          ...
          <div className="mt-3 flex gap-2">
            <Button onClick={() => pick("scam")} variant="destructive" disabled={!!answered}>Scam</Button>
            <Button onClick={() => pick("safe")} variant="outline" disabled={!!answered}>Safe</Button>
            {answered && (
        ...
        <section className="rounded-lg border p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {filteredDB.map((r) => (
              <div key={r.name} className="rounded border p-4">
